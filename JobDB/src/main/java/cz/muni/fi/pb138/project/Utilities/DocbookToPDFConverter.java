...
public class DocbookToPDFConverter {
    ...
    public DocbookToPDFConverter(){
        if (fopFactory == null){
            try {
                File cfgFile = new File(DocbookToPDFConverter.class.getResource("fopCfg.xml").getPath());
    ...
    public void convert(String XMLcontent, String resultPdfPath){
        ...
        String FOcontent = new XSLTProcessor().applyXSL(
                XMLcontent,DocbookToPDFConverter.class.getResource("docbook-xsl/fo/docbook.xsl").getPath());
